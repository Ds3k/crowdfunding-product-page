...
const progressBar = document.querySelector(".progress-bar-transition");
const logo = document.querySelector("#logo");
const openNav = document.querySelector("#openNav");
const closeNav = document.querySelector("#closeNav");
const navToggles = [openNav, closeNav];
const mobileNav = document.querySelector("#mobile-nav");
const desktoptNav = document.querySelector("#desktop-nav");
const bookmark = document.querySelector("#btn-bookmark");
const bookmarkLabel = document.querySelector("#btn-bookmark p");
...
finalizeButton.addEventListener("click", () => {
    ...
    //logo.classList.toggle("inactive");
    openNav.classList.toggle("inactive");
    dataContainer.classList.toggle("loading");
